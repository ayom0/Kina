...
class _LandscapePageState extends State<LandscapePage> {
  ...
  Future<void> _playVoiceOver() async {
    if (isSoundOn) {
      await audioPlayer.play(AssetSource('audio/19v.mp3'));
    }
  }
  ...
  void _navigateToNextPage() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Halaman10()),
    );
  }
  ...
  void _navigateToPreviousPage() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Halaman8()),
    );
  }
              ...
              child: AnimatedTextKit(
                animatedTexts: [
                  TypewriterAnimatedText(
                    'Iblis menggoda Hawa untuk mendekati pohon larangan. Hawa pun terpengaruh dan mengajak Adam untuk memakan buah dari pohon tersebut, melanggar perintah Allah.',
