...
class _LandscapePageState extends State<LandscapePage> {
  ...
  Future<void> _playVoiceOver() async {
    if (isSoundOn) {
      await audioPlayer.play(AssetSource('audio/hal4.mp3'));
    }
  }
              ...
              child: AnimatedTextKit(
                animatedTexts: [
                  TypewriterAnimatedText(
                    'Saya lebih baik daripadanya, Engkau ciptakan saya dari api, sedangkan dia Engkau ciptakan dari tanah, Ucap Iblis',
