...
import 'halaman19.dart';
import 'halaman21.dart';
...
class _LandscapePageState extends State<LandscapePage> {
  ...
  Future<void> _playVoiceOver() async {
    if (isSoundOn) {
      await audioPlayer.play(AssetSource('audio/halaman20.mp3'));
    }
  }
  ...
  void _navigateToNextPage() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Halaman21()),
    );
  }
  ...
  void _navigateToPreviousPage() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Halaman19()),
    );
  }
