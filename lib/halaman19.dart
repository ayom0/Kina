...
import 'halaman18.dart';
import 'halaman20.dart';
...
class _LandscapePageState extends State<LandscapePage> {
  ...
  Future<void> _playVoiceOver() async {
    if (isSoundOn) {
      await audioPlayer.play(AssetSource('audio/halaman19.mp3'));
    }
  }
  ...
  void _navigateToNextPage() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Halaman20()),
    );
  }
  ...
  void _navigateToPreviousPage() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Halaman18()),
    );
  }
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('images/bghal19.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          ),
